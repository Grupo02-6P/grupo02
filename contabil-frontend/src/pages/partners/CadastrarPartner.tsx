...
const CadastrarPartner: React.FC = () => {
  ...
  console.log('User Role:', user, 'Is Admin:', isAdmin);

  const handleInputChange = (field: keyof CreatePartnerDto, value: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const dataToSend: CreatePartnerDto = {
        ...formData,
      ...
      await partnerService.create(dataToSend);
      ...
      setInfoModal({
        isOpen: true,
        title: 'Erro',
        message: error.message || 'Erro ao cadastrar parceiro. Tente novamente.',
        confirmText: 'Fechar',
        type: 'danger',
        onConfirm: () => setInfoModal({ ...infoModal, isOpen: false })
      });
          ...
          <form onSubmit={handleSubmit} className="p-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                ...
                <li>• Novos parceiros são criados com status ativo por padrão</li>
              </ul>
            </div>
...
export default CadastrarPartner;

...
class PartnerService {
  ...
  // Criar novo parceiro
  async create(data: CreatePartnerDto): Promise<PartnerResponse> {
    try {
  ...
  async findAll(params?: PaginationParams): Promise<PartnerListResponse> {
    try {
  ...
  // Atualizar parceiro
  async update(id: string, data: UpdatePartnerDto): Promise<PartnerResponse> {
    try {
